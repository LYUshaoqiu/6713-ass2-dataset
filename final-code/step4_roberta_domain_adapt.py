...
train_loader = DataLoader(HateDataset(course_train['text'], course_train['label']), batch_size=BATCH_SIZE, shuffle=True, num_workers=0)
val_loader = DataLoader(HateDataset(course_val['text'],   course_val['label']), batch_size=BATCH_SIZE, num_workers=0)
