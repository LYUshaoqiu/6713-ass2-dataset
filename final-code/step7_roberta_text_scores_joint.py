...
def main() -> None:
    ...
    parser.add_argument("--model-dir", default=os.path.join(os.path.dirname(__file__), "roberta_HateXPlain"))
    parser.add_argument("--output-dir", default=os.path.join(os.path.dirname(__file__), "results_text_scores_joint"))
