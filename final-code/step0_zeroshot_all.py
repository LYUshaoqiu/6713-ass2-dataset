...
Outputs (saved to results/):
  results/zeroshot_all_results.csv          — combined metrics table
  results/zeroshot_<model>_<dataset>_cm.png — confusion matrix per model × dataset
"""
import os, gc
...
for display_name, model_id, tok_kwargs, mdl_kwargs in MODELS:
    ...
    for ds_name, df in DATASETS.items():
        ...
        plt.tight_layout()
        fname = f'results/zeroshot_{safe(display_name)}_{ds_name}_cm.png'
...
results_df.to_csv('results/zeroshot_all_results.csv', index=False)
print('\nSaved: results/zeroshot_all_results.csv')
